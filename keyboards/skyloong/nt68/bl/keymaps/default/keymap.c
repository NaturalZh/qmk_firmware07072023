...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,     _______,  _______,    _______,  _______,     _______,    BL_TOGG,   BL_BRTG,   BL_BRTG,   _______,
        ...
        _______,  _______,  _______,  _______,            _______,                                     _______,     _______,     KC_LEFT,  BL_DOWN,             KC_RIGHT
    ),
