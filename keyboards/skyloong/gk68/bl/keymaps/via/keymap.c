...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN_INDEX] =  LAYOUT_all(
        ...
        _______,  _______,    TO(0),    TO(1),  _______,  _______,     _______,  _______,    _______,  _______,         _______,     BL_BRTG,  BL_BRTG,   BL_TOGG,   KC_MPLY,
        ...
        _______,  _______,  _______,            _______,               _______,              _______,  KC_RALT,         _______,     KC_RCTL,  KC_LEFT,   BL_DOWN,  KC_RIGHT
    ),

    [_MAC_INDEX] = LAYOUT_all(
        KC_GRV ,   KC_F14,   KC_F15, C(KC_UP),  G(KC_D), G(KC_SPC),  LSG(KC_4),  KC_MPRV,    KC_MPLY,  KC_MNXT,         KC_MUTE,     KC_VOLD,  KC_VOLU,    KC_DEL,   BL_TOGG,
        _______,  _______,    TO(0),    TO(1),  _______,  _______,     _______,  _______,    _______,  _______,         _______,     BL_BRTG,  BL_BRTG,   BL_TOGG,   KC_MPLY,
        _______,  _______,  _______,  _______,  _______,  _______,     _______,  _______,    _______,  _______,         _______,     _______,             _______,   KC_HOME,
        _______,  _______,  _______,  _______,  _______,  _______,     _______,  _______,    _______,  _______,         _______,               _______,     BL_UP,    KC_END,
        _______,  KC_LALT,  KC_LGUI,            _______,               _______,              _______,  KC_RGUI,         _______,     KC_RALT,  KC_LEFT,   BL_DOWN,  KC_RIGHT
    )
};
